...
func (g *Game) canMove(dx, dy int) bool {
	...
	within_border := true
	within_border = within_border && newX >= int(borderThickness/float64(cellSize))
	within_border = within_border && newX+g.activePiece.width <= gridSize-int(borderThickness/float64(cellSize))
	within_border = within_border && newY >= int(borderThickness/float64(cellSize))
	within_border = within_border && newY+g.activePiece.height <= gridSize-int(borderThickness/float64(cellSize))
